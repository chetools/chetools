# This code is copied Chris Redford's DotMap: https://github.com/drgrib/dotmap
# with very minor modifications to cleanup iPython ouput and replaced OrderedDict with
# Python dict that is ordered by default. 
...
class DotMap(dict):
    ...
    def __str__(self, seen = None):
        ...
        for k,v in self.__call_items(self._map):
            if (k.endswith('_') and (k.startswith('_repr_') or k.startswith('_ipython_'))):
                continue
    ...
    def fromkeys(cls, seq, value=None):
        d = cls()
        d._map = dict.fromkeys(seq, value)
        return d
